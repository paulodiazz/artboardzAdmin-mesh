  ...
  return (
    <div style={{ paddingRight: '1rem'}}>
      <svg
        ...
        className={className}
      >
        <g clipPath="url(#clip0_1_10500)">
          <path
            d="M15.333 14V12.6667C15.3326 12.0758 15.1359 11.5019 14.7739 11.0349C14.4119 10.5679 13.9051 10.2344 13.333 10.0867"
            stroke="white"
            strokeWidth="2"
            strokeLinecap="round"
...
export default CollectorsIcons;
